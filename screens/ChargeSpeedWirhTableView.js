...
const ChargeSpeedWirhTableView = () => {
  ...
  return (
    ...
    >
      <Image
        style={[styles.neonBackgroundIcon, styles.neonBackgroundIconLayout]}
        resizeMode="cover"
      ...
      <View style={styles.battery}>
        ...
        <View style={styles.view}>
          ...
          <View style={[styles.view2, styles.viewFlexBox]}>
            ...
            />
            <Text style={[styles.text2, styles.textFlexBox]}>100%</Text>
          </View>
        </View>
        ...
        <Text style={[styles.text2, styles.textFlexBox]}>Set Charge Limit</Text>
      </View>
      ...
      <View
        style={[styles.modeDescriptionWrapper, styles.neonBackgroundIconLayout]}
      >
...
export default ChargeSpeedWirhTableView;
