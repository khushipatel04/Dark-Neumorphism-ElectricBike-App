...
const LockUnlockPage = () => {
  ...
  return (
    ...
    >
      ...
      <View style={[styles.lock, styles.lockFlexBox]}>
      ...
      <Image
        style={styles.lockunlockPageChild}
        resizeMode="cover"
        source={require("../assets/frame-3741.png")}
      />
    </LinearGradient>
  );
};
