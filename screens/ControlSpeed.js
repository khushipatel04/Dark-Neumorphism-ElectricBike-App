...
const ControlSpeed = () => {
  ...
  return (
    <LinearGradient
      style={[styles.controlSpeed, styles.fastSettingBorder]}
      locations={[0, 0.99]}
...
22`}</Text>
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/ellipse-stroke3.png")}
        />
        <Image
          style={[styles.ellipseStrokeIcon, styles.ellipseIconLayout]}
          resizeMode="cover"
          source={require("../assets/ellipse-stroke4.png")}
        />
      </View>
      <View style={styles.clipContent}>
        <View style={styles.mode}>
          ...
          <View style={[styles.fanControl, styles.textFlexBox]}>
            <View style={[styles.icon, styles.textFlexBox]}>
              <Text style={[styles.ac, styles.acTypo]}>Fan</Text>
        ...
        <View style={styles.parentFlexBox}>
          ...
          <View style={[styles.group, styles.groupFlexBox]}>
            ...
            <View style={styles.num1}>
              <Text style={[styles.text11, styles.textTypo1]}>20°</Text>
            </View>
